...
public enum AppStatus {
	GREEN("Code Green - All good fam"), YELLOW("Code Yellow - Degraded performance"), RED(
			"Code Red – Something needs to be done immediately"), BLUE(
					"Code Blue - Under maintenance"), GRAY("Code Gray - initializing");
