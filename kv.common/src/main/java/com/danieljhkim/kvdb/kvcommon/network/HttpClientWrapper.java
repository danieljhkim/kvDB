 ...
 *
 * <p>
 * Map<String, String> payload = Map.of("key", "foo", "value", "bar"); client.post("http://localhost:9001/set",
 * payload);
 *
 * <p>
 * String value = client.get("http://localhost:9001/get?key=foo", String.class); System.out.println("Value: " + value);
 */
