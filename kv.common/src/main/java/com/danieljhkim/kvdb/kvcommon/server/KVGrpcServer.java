 ...
 *
 * <p>
 * KVGrpcServer server = new KVGrpcServer.Builder() .setPort(8080) // Set the desired port .addService(new
 * KVServiceImpl(new KVStoreRepository())) // Add gRPC service .build();
 *
 * <p>
 * server.start();
 */
