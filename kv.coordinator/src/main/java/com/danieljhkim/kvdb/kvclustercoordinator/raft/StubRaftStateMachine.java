 ...
 *
 * <p>
 * This is suitable for development, testing, and single-coordinator deployments. For production HA, replace with a real
 * Raft implementation (e.g., Apache Ratis, MicroRaft).
 */
