...
public class GatewayApplication {
    ...
    public static void main(String[] args) {
        ...
        String coordinatorHost = CONFIG.getProperty("kvdb.gateway.coordinator.host", DEFAULT_COORDINATOR_HOST);
        int coordinatorPort = parsePort(
                CONFIG.getProperty("kvdb.gateway.coordinator.port", String.valueOf(DEFAULT_COORDINATOR_PORT)),
