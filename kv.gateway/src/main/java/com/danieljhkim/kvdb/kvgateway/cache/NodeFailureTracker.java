 ...
 * Acts as a negative cache to improve retry efficiency.
 */
public class NodeFailureTracker {
	 ...
	 *
	 * @param failureTtlMs
	 *            how long to remember a node failure in milliseconds
	 */
	 ...
	 *
	 * @param nodeAddress
	 *            the address of the failed node (e.g., "localhost:8001")
	 */
