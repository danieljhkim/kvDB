...
/**
 * Manages gRPC connections to storage nodes. Creates channels on-demand and caches them by node address.
 */
public class NodeConnectionPool {
     ...
     *
     * @param nodeAddress The node address in "host:port" format
     ...
     *
     * @param nodeAddress The node address to remove
     */
