...
/**
 * Extracts routing hints from gRPC trailers for gateway retry/invalidation logic.
 *
 * <p>
 * The {@link GlobalExceptionInterceptor} is responsible for attaching these keys to trailers when services throw domain
 * exceptions.
 * </p>
 */
public final class GrpcRoutingHints {
    ...
    public record RoutingHints(Optional<String> shardId, Optional<String> leaderHint, Optional<String> newNodeHint) {
