...
/**
 * Configuration for retry behavior in the gateway.
 * Defines retry attempts, backoff parameters, and retryable error codes.
 */
public class RetryPolicy {
	...
	public static class Builder {
		...
		private Set<Status.Code> retryableStatusCodes = Set.of(
