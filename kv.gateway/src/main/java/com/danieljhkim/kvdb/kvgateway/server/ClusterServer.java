...
import com.danieljhkim.kvdb.kvgateway.handler.ClusterClientHandler;
...
/**
 * ClusterServer is the main server class that manages cluster nodes and handles
 * client connections.
 * It initializes cluster nodes from a configuration file and accepts client
...
public class ClusterServer {
	...
	private final int healthCheckInterval = Integer
			.parseInt(CONFIG.getProperty("kvdb.server.healthCheckInterval", "5"));
	...
	/**
	 * Gracefully shut down the server: - stop accepting new connections - stop
	 * health checks - stop
	 * worker threads
	 */
