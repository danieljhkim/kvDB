...
/**
 * Node-side client for communicating with the Coordinator service. Used to fetch shard map snapshots for leader/replica
 * validation.
 */
public class CoordinatorShardMapClient {
     ...
     *
     * @param ifVersionGt only return map if greater than this version
