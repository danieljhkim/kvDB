 ...
 *
 * <p>
 * This milestone uses a temporary single write leader model: only the configured write leader accepts writes
 * (Set/Delete).
 */
public class NodeLeadership {
    ...
    public NodeLeadership(String nodeId, String writeLeaderId, String writeLeaderHost, int writeLeaderPort) {
        this.nodeId = nodeId;
